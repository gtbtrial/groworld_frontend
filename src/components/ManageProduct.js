	...
	<div className="login">
		<div className="container">
			...
			<div className="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				...
				<textarea name="descp" onChange={(e)=>setdescrip(e.target.value)} placeholder="Description" className="form-control" required=" "></textarea><br/>

                Featured 
            <label><input type="radio" name="featured" value="yes" onChange={(e)=>setfeat(e.target.value)}/>Yes</label>
            <label><input type="radio" name="featured" value="no" onChange={(e)=>setfeat(e.target.value)}/>No</label>
